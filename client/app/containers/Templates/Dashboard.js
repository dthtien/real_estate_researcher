...
import { GuideSlider } from 'app-components';
import { toggleAction, openAction, playTransitionAction } from 'app-actions/UiActions';
...
class Dashboard extends React.Component {
  ...
  render() {
    ...
    const place = parts[parts.length - 1].replace('-', ' ').replace('_', ' ');
    return (
      <div
        className={
          classNames(
