...
ActiveRecord::Schema.define(version: 2019_11_02_100708) do
  ...
  create_table "history_prices", force: :cascade do |t|
    ...
    t.index ["total_price", "acreage", "land_id", "posted_date"], name: "history_prices_unique_information", unique: true
  end
